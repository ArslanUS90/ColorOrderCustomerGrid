...
namespace ArslanFarrukh\ColorOrderCustomerGrid\Helper;
...
class Config extends AbstractHelper
{
    ...
    const ENABLED_ORDERS_GRID_CONFIG_PATH = 'arslan_colorgrids/general/enable_orders_grid';
    const ENABLED_CUSTOMERS_GRID_CONFIG_PATH = 'arslan_colorgrids/general/enable_customer_grid';
